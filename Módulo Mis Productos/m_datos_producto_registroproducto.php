...
$json=array();
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        $update="CALL sp_m_datos_producto_registroproducto('{$p_lptStock}','{$imagePath1}','{$imagePath2}','{$imagePath3}','{$p_lptPrecioCompra}','{$p_lptPrecioVenta}','{$p_idListadoProductoTienda}','{$p_idValidacionImagen}')";
