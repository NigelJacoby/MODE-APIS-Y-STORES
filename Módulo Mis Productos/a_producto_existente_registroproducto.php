...
$json=array();
    if($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        $insert="CALL sp_a_producto_existente_registroproducto('{$p_lptStock}','{$p_lptStockMinimo}','{$p_lptImagen1}','{$p_lptPrecioCompra}','{$p_lptPrecioVenta}','{$p_idProducto}','{$p_idTienda}')";
